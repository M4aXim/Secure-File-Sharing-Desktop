...
function App() {
  ...
  const handleForgotPassword = () => {
    ...
    fetch(
      `https://hackclub.maksimmalbasa.in.rs/api/change-password/${encodeURIComponent(
        email
      )}`,
      {
        method: "POST",
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://hackclub.maksimmalbasa.in.rs/api/login",
        {
          method: "POST",
          headers: {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://hackclub.maksimmalbasa.in.rs/api/register",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleGoogleLoginSuccess = async (token) => {
    ...
    try {
      const response = await fetch(
        "https://hackclub.maksimmalbasa.in.rs/api/verify-token",
        {
          method: "GET",
          headers: {
  ...
  const handleRequestOTP = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://hackclub.maksimmalbasa.in.rs/api/request-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (data.message) {
        showNotification(
          "If your email is registered, a one-time password has been sent",
          "is-success"
        );
        setOtpEmail(email);
  ...
  const handleLoginWithOTP = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://hackclub.maksimmalbasa.in.rs/api/login-with-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            ...
            isAuthenticated ? (
              ...
              <div className="app-container">
                  ...
                  <div className="container">
                        ...
                        <div className="columns is-vcentered">
                          <div className="column">
                            ...
                            <p className="is-size-5 mt-4 has-text-grey">
                              Share files with ease, access from anywhere, and keep your data
                              secure.
                            </p>
                            <div className="buttons mt-5">
                              <button
                                className="button is-primary is-medium px-5"
                              ...
                              <button
                                className="button is-link is-medium px-5"
                              ...
                              <button
                                className="button is-danger is-medium px-5"
                                onClick={() => (window.location.href = "https://hackclub.maksimmalbasa.in.rs/law.html")}
                              >
                                <span className="icon">
                          ...
                          <div className="column is-hidden-mobile">
                            <img
                              src="https://hackclub.maksimmalbasa.in.rs/assets/Picture.png"
                    ...
                    {activeForm === "login" && (
                      <div className="form-card p-5">
                        ...
                        <p className="subtitle is-6 has-text-centered has-text-grey mb-5">
                    ...
                    {activeForm === "otp-login" && (
                      <div className="form-card p-5">
                        ...
                        {!showOtpSection ? (
                          ...
                          <form onSubmit={handleLoginWithOTP} className="form">
                            <div className="field">
                              <label className="label">Email</label>
                              <div className="control has-icons-left">
                                <input
                    ...
                    <div className="features mt-6">
                      <h2 className="title is-3 has-text-centered mb-6">
                          ...
                          <div className="box feature-card p-5">
                            <div className="has-text-centered">
                              ...
                              <p className="has-text-grey">
                                Your files are encrypted and stored safely on our servers.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="column is-4">
                          <div className="box feature-card p-5">
                            <div className="has-text-centered">
                              ...
                              <p className="has-text-grey">
                                Upload and download files at lightning-fast speeds.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="column is-4">
                          <div className="box feature-card p-5">
                            <div className="has-text-centered">
                              ...
                              <p className="has-text-grey">
                                Share files with anyone using simple links or direct invites.
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <footer>
                  <div>
                    <p>
                      <strong>FileShare</strong> &copy; 2025 | Made with{" "}
                      <i className="fas fa-heart has-text-danger"></i> by Maksim
                    </p>
                    <div className="mt-3">
                      <a
                        href="https://hackclub.maksimmalbasa.in.rs/privacy.html"
                        className="has-text-grey mr-3"
                      >
                        Privacy Policy
                      </a>
                      <a
                        href="https://hackclub.maksimmalbasa.in.rs/TOS.html"
                        className="has-text-grey mr-3"
                      >
                        Terms of Service
                      </a>
                      <a
                        href="https://hackclub.maksimmalbasa.in.rs/contact.html"
